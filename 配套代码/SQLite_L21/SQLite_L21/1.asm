; Listing generated by Microsoft (R) Optimizing Compiler Version 19.24.28117.0 
	...
	TITLE	C:\Users\libit\source\repos\SQLite_L21\SQLite_L21\SQLite_L21.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG5563	DB	'e_f: %d,%d,%d,%d,%d', 0aH, 00H
	ORG $+3
$SG5583	DB	'Hello World!', 0aH, 00H
	ORG $+2
$SG5584	DB	'sqlite3_exec: 0x%p', 0aH, 00H
CONST	ENDS
...
_TEXT	SEGMENT
_main	PROC
; File C:\Users\libit\source\repos\SQLite_L21\SQLite_L21\SQLite_L21.cpp
; Line 31
	push	ebp
	mov	ebp, esp
; Line 32
...
; Line 33
	push	0
	push	0
	push	OFFSET ?c_f@@YAHHHHH@Z			; c_f
	push	0
	push	0
	call	?sqlite3_exec@@YAHHHP6AHHHHH@ZHH@Z	; sqlite3_exec
	add	esp, 20					; 00000014H
; Line 34
	push	OFFSET ?sqlite3_exec@@YAHHHP6AHHHHH@ZHH@Z ; sqlite3_exec
	push	OFFSET $SG5584
	call	_printf
	add	esp, 8
; Line 35
